...
if parallel:
    ...
    train_data['input_ids'] = train_data['input_ids'].repeat(popsize, 1)
    train_data['attention_mask'] = train_data['attention_mask'].repeat(popsize, 1)
    train_data['mask_pos'] = train_data['mask_pos'].repeat(popsize)
